...
- `kfcsx2/` - Emulator core, including the EE, IOP, VUs, GS, SPU2, input,
  storage, networking, and hardware device implementations.
- `kfcsx2-qt/` - Qt desktop frontend, settings dialogs, debugger, game list,
  translations, and UI resources.
- `common/` - Shared utilities and platform abstraction used throughout the
  project.
- `kfcsx2-gsrunner/` - Standalone GS dump runner used for graphics testing and
  debugging.
